...
void Ospfv2Interface::sendHelloPacket(Ipv4Address destination, short ttl)//destination = 224.0.0.5;
{
    Ospfv2Options options;
    const auto& helloPacket = makeShared<Ospfv2HelloPacket>(); //create hello packet
