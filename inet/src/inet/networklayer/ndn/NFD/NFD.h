...
class INET_API NFD : public OperationalBase, public INetworkProtocol, public NetfilterBase, public IProtocolRegistrationListener, public cListener
{
public:
    struct SimRecorder
    {
...
public:
    ...
    void cachePacket(const iName &interest, Packet* packet);
    ...
    void cacheData(const iName &interest, Packet *packet);
    ...
    void fragmentAndStore(Packet* packet, const iName& interest);
