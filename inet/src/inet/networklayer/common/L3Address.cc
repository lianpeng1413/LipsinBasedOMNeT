...
#include "inet/networklayer/contract/ndn/iType.h" // for ndn
...
//void L3Address::set(const iName& addr)  //TODO
//{
//    const uint32 *words = addr.words();
//    hi = ((uint64) * (words + 0) << 32) + *(words + 1);
//    lo = ((uint64) * (words + 2) << 32) + *(words + 3);
//
//    if (getType() != ndnName)
//        throw cRuntimeError("Cannot set ndn name");
//}
