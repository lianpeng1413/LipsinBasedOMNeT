...
const BloomFilterLipsin * LipsinHeader::getPreRoute() const
{
    return this->preRoute;
}

void LipsinHeader::setPreRoute(BloomFilterLipsin * preRoute)
{
    handleChange();
    this->preRoute = preRoute;
}

const BloomFilterLipsin * LipsinHeader::getHadRoute() const
{
    return this->hadRoute;
}

void LipsinHeader::setHadRoute(BloomFilterLipsin * hadRoute)
{
    handleChange();
...
const char *LipsinHeaderDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::BloomFilterLipsin",    // FIELD_preRoute
        "inet::BloomFilterLipsin",    // FIELD_hadRoute
    };
...
const char *LipsinHeaderDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    ...
    LipsinHeader *pp = (LipsinHeader *)object; (void)pp;
    switch (field) {
        case FIELD_preRoute: { const BloomFilterLipsin * value = pp->getPreRoute(); return omnetpp::opp_typename(typeid(*value)); }
        case FIELD_hadRoute: { const BloomFilterLipsin * value = pp->getHadRoute(); return omnetpp::opp_typename(typeid(*value)); }
        default: return nullptr;
    }
}
