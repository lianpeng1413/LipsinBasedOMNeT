...
#include "inet/networklayer/lipsin/bloomFilter/BloomFilter_m.h" // import inet.networklayer.lipsin.bloomFilter.BloomFilter
...
class INET_API LipsinHeader : public ::inet::FieldsChunk
{
  protected:
    ...
    uint64_t nonce = 0;
    BloomParameters para;
    BloomFilter * preRoute = nullptr;
    BloomFilter * hadRoute = nullptr;
  ...
  public:
    ...
    virtual const BloomFilter * getPreRoute() const;
    virtual BloomFilter * getPreRouteForUpdate() { handleChange();return const_cast<BloomFilter *>(const_cast<LipsinHeader*>(this)->getPreRoute());}
    virtual void setPreRoute(BloomFilter * preRoute);
    virtual const BloomFilter * getHadRoute() const;
    virtual BloomFilter * getHadRouteForUpdate() { handleChange();return const_cast<BloomFilter *>(const_cast<LipsinHeader*>(this)->getHadRoute());}
    virtual void setHadRoute(BloomFilter * hadRoute);
